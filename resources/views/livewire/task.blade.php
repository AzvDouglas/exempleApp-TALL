<div class="flex-column justify-center w-3/4">
    ...
    <form wire:submit.blur="save" class="p-4">
        <div class="mb-4">
            <input wire:model="title" class="p-2 bg-gray-200 w-full" type="text"  placeholder="Tarefa...">
        </div>            <div class="mb-4">
            <textarea wire:model="description" class="p-2 bg-gray-200 w-full" placeholder="Descrição da tarefa"></textarea>
        </div>
        <button type="submit" class="bg-indigo-700 text-white font-bold w-full rounded shadow p-2">Guardar</button>
    </form>
</div>
